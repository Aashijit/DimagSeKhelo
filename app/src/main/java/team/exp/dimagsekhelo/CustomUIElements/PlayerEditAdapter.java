...
public class PlayerEditAdapter extends ArrayAdapter<PlayerResponse> implements Codes {
    private final Activity context;
    private List<PlayerResponse> playerResponses;
    private DateUtils dateUtils;
    private TextView textView;

    public PlayerEditAdapter(Activity context, List<PlayerResponse> playerResponses,TextView textView) {
